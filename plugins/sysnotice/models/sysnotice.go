...
type SysNotice struct {
	...
	Publisher      *models.User        `gorm:"foreignKey:PublisherID;references:ID" json:"publisher,omitempty"`
	...
	Targets        SysNoticeTargetList `gorm:"foreignKey:NoticeID;references:ID" json:"targets,omitempty"`
